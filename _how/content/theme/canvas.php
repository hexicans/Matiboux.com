...
<div class="main">
	<div class="container">
		<div class="backnet" id="backnet" style="height: 400px;">
			<canvas id="backnet-canvas" width="863" height="483"></canvas>
			<h1 class="backnet-title">from SquareMS</h1>
			<p class="backnet-text">IT IS AWESOME. KINDLY WOW</p>
		</div>
	</div>
</div>
...
<div class="footer">
	...
	<li>
		<a href="https://ms.kandles.eu/">Go to SquareMS</a>
