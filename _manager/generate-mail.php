	...
	<div class="main">
		<div class="container">
			...
			<p>
				...
				Y accéder :
				<a href="<?php echo $_Oli->getOption('url'); ?>tickets/view/<?php echo $params['ticketKey']; ?>">
					<b>#<?php echo $params['ticketKey']; ?></b>
				</a>
			</p> <hr />
			
			<h3>Restez attentifs</h3>
			<p>
				<b>Tous avertis</b> <br />
			...
			<p>
				...
				<a href="<?php echo $_Oli->getShortcutLink('home'); ?>"><?php echo $_Oli->getOption('owner'); ?></a>
