...
<body>
	<div id="container">
		...
		<div class="tips">
			Une suggestion, un avis, un problème ? <a href="https://twitter.com/intent/tweet?text=%40Matiboux%20%23ImgShot%20">Envoyez-nous un Tweet</a> !
		</div>
		<div class="tips">
		...
		<?php if(!getStatus()) { ?>
			<div class="error">Service indisponible</div>
		<?php } ?>
		<?php if(getUrlParam(2) != '') { ?>
			<div class="error"><?php echo CheckError(getUrlParam(2)); ?></div>
		<?php } ?>
		<?php if(getStatus()) { ?>
