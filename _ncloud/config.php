...
$_Oli->setSettingsTables(['settings_natrox_cloud', 'settings']); // Dans l'ordre de priorité : [1,2,3]
...
$_Upload->setUploadTable('natrox_cloud_uploads');
$_Upload->setUploadPath(MEDIAPATH);
$_Upload->setUploadUrl($_Oli->getMediaUrl());

/** Set Upload Table & Path */
// $_Upload->setMaxSize(1048576); // 1048576 => 1 Mo
$_Upload->setMaxSize(25165824); // 25165824 => 24 Mo
$_Upload->setNameLength(24);
$_Upload->setAllowedTypes('*');
// die('Service fermé (pour préserver la sécurité du serveur)');
