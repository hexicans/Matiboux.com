		...
		<nav class="collapse navbar-collapse bs-navbar-collapse">
			<ul class="nav navbar-nav navbar-left">
				...
				<li<?php if($_Oli->getUrlParam(1) == 'upload') echo ' class="active"'; ?>>
					<a href="<?php echo $_Oli->getOption('url'); ?>upload/">Mise en ligne</a>
				</li>
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						...
						<li>
							<a href="<?php echo $_Oli->getOption('url'); ?>my-files/">Mes fichiers</a>
						</li>
					</ul>
				</li>
				<li<?php if($_Oli->getUrlParam(1) == 'about') echo ' class="active"'; ?>>
					<a href="<?php echo $_Oli->getOption('url'); ?>about/">A propos</a>
				</li>
			</ul>
