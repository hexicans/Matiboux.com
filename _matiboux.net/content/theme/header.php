	...
	<div class="container">
		...
		<nav class="collapse navbar-collapse bs-navbar-collapse">
			<ul class="nav navbar-nav navbar-left">
				...
				<li <?php if($_Oli->getUrlParam(1) == 'portal') echo 'class="active"'; ?>>
					<a href="<?php echo $_Oli->getOption('url'); ?>portal/">Projets (portail)</a>
				</li>
				<li <?php if($_Oli->getUrlParam(1) == 'career') echo 'class="active"'; ?>>
					<a href="<?php echo $_Oli->getOption('url'); ?>career/">Parcours</a>
				</li>
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						<li class="disabled">
							<a href="#<?php //echo $_Oli->getOption('url'); ?>">A propos</a>
						</li>
						<li>
							<a href="<?php echo $_Oli->getOption('url'); ?>thanks/">Remerciements</a>
						</li>
					</ul>
				</li>
			</ul>
