	...
	<div class="container">
		...
		<nav class="collapse navbar-collapse bs-navbar-collapse">
			<ul class="nav navbar-nav navbar-left">
				...
				<li<?php if($_Oli->getUrlParam(1) == 'upload') echo ' class="active"'; ?>>
					<a href="<?php echo $_Oli->getOption('url'); ?>upload/">Mettre en ligne</a>
				</li>
				<li<?php if($_Oli->getUrlParam(1) == 'settings') echo ' class="active"'; ?>>
					<a href="<?php echo $_Oli->getOption('url'); ?>settings/">Paramètres</a>
				</li>
				<li<?php if($_Oli->getUrlParam(1) == 'my-files') echo ' class="active"'; ?>>
					<a href="<?php echo $_Oli->getOption('url'); ?>my-files/">Mes images</a>
				</li>
			</ul>
